...
/**
 * Json inflator utility: map access
 * Access values from a dynamic map easily and safely with data conversion
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InflatorMapUtil
{
    // --
    // Members
    // --

    private InflatorColorLookup colorLookup;
    private InflatorDimensionLookup dimensionLookup;
    ...
    public InflatorMapUtil()
    {
        this(null, null);
    }

    public InflatorMapUtil(@Nullable InflatorColorLookup colorLookup, @Nullable InflatorDimensionLookup dimensionLookup)
    {
    ...
    @Nullable
    public InflatorColorLookup getColorLookup()
    {
        return colorLookup;
    }

    @Nullable
    public InflatorDimensionLookup getDimensionLookup()
    {
    ...
    public Map<String, Object> asStringObjectMap(@Nullable Object object)
    {
        if (isMap(object))
        {
            Map<?, ?> map = (Map<?, ?>)object;
    ...
    public boolean isMap(@Nullable Object object)
    {
    ...
    @NotNull
    @SuppressWarnings("unchecked")
    public List<Object> optionalObjectList(@Nullable Map<String, Object> map, @NotNull String key)
    {
        if (map != null)
        {
    ...
    @NotNull
    public List<String> optionalStringList(@Nullable Map<String, Object> map, @NotNull String key)
    {
        if (map != null)
        {
            Object object = map.get(key);
    ...
    @NotNull
    public List<Double> optionalDoubleList(@Nullable Map<String, Object> map, @NotNull String key)
    {
        if (map != null)
        {
            Object object = map.get(key);
    ...
    @NotNull
    public List<Float> optionalFloatList(@Nullable Map<String, Object> map, @NotNull String key)
    {
        if (map != null)
        {
            Object object = map.get(key);
    ...
    @NotNull
    public List<Integer> optionalIntegerList(@Nullable Map<String, Object> map, @NotNull String key)
    {
        if (map != null)
        {
            Object object = map.get(key);
    ...
    @NotNull
    public List<Boolean> optionalBooleanList(@Nullable Map<String, Object> map, @NotNull String key)
    {
        if (map != null)
        {
            Object object = map.get(key);
    ...
    @NotNull
    public List<Integer> optionalColorList(@Nullable Map<String, Object> map, @NotNull String key)
    {
        if (map != null)
        {
            Object object = map.get(key);
    ...
    @NotNull
    public List<Integer> optionalDimensionList(@Nullable Map<String, Object> map, @NotNull String key)
    {
        if (map != null)
        {
            Object object = map.get(key);
    ...
    public int optionalColor(@Nullable Map<String, Object> map, @NotNull String key, int defaultValue)
    {
        if (map != null)
        {
    ...
    public int optionalDimension(@Nullable Map<String, Object> map, @NotNull String key, int defaultValue)
    {
        if (map != null)
        {
    ...
    @Nullable
    public Date optionalDate(@Nullable Map<String, Object> map, @NotNull String key, @Nullable Date defaultValue)
    {
        if (map != null)
        {
            Object object = map.get(key);
    ...
    @Nullable
    public String optionalString(@Nullable Map<String, Object> map, @NotNull String key, @Nullable String defaultValue)
    {
        if (map != null)
        {
    ...
    public double optionalDouble(@Nullable Map<String, Object> map, @NotNull String key, double defaultValue)
    {
        if (map != null)
        {
    ...
    public float optionalFloat(@Nullable Map<String, Object> map, @NotNull String key, float defaultValue)
    {
        if (map != null)
        {
    ...
    public int optionalInteger(@Nullable Map<String, Object> map, @NotNull String key, int defaultValue)
    {
        if (map != null)
        {
    ...
    public boolean optionalBoolean(@Nullable Map<String, Object> map, @NotNull String key, boolean defaultValue)
    {
        if (map != null)
        {
    ...
    @Nullable
    private Integer objectToDimension(@Nullable Object object)
    {
        if (object instanceof String)
        {
    ...
    @Nullable
    private Integer objectToColor(@Nullable Object object)
    {
        if (object instanceof String)
        {
            // Handle lookup
    ...
    @Nullable
    private Double objectToDouble(@Nullable Object object)
    {
        if (object instanceof String)
        {
            try
    ...
    @Nullable
    private Float objectToFloat(@Nullable Object object)
    {
        if (object instanceof String)
        {
            try
    ...
    @Nullable
    private Integer objectToInteger(@Nullable Object object)
    {
        if (object instanceof String)
        {
            try
    ...
    @Nullable
    private Boolean objectToBoolean(@Nullable Object object)
    {
        if (object instanceof String)
        {
            try
